...
!-------------------------------------------------------------------------------
   ...
   use mymodules3, only: fjdkl, fjdkla, gja, fjdla, fjdla, fjdla, fjdla, fjdla,&
                              fjdla, fjdla, fjdla, fjdla, fjdla, fdjalk, fjklda
   implicit none
!
   private
!
...
!-------------------------------------------------------------------------------
   use mymodules3, only: fjdkl, fjdkla, gja, fjdla, fjdla, fjdla, fjdla, fjdla,&
                             fjdla, fjdla, fjdla, fjdla, fjdla, fdjalk, fjklda ! my commnet 11
   implicit none
!
   real :: aaa, bbb, ccc, ddd, eee, ffff, dfa, dfa, dfa, dfa, dfa, dfa, dfa,   &
                                                                  dfa, dfa, dfa
!
   zzz = aaa+bbb+ccc+ddd+eee+fff+ggg+hhh+iii+jjj+kkk+lll+mmm+nnn+ooo+ppp+qqq+  &
               rrr+sss+ttt+uuu+vvv+www+xxx+aaa+bbb+ccc+ddd+eee+fff+ggg+hhh+iii+&
                    jjj+kkk+lll+mmm+nnn+ooo+ppp+qqq+rrr+sss+ttt+uuu+vvv+www+xxx
   call my_sub(aaa,bbb,ccc,ddd,eee,fff,ggg,hhh,iii,jjj,kkk,lll,mmm,nnn,ooo,ppp,&
                                                                       qqq,rrr)
   call my_sub(aaa,bbb,ddd,fff,ggg,zzz)
   call my_sub(fdjakfjdalsjfdklasjfkldjsakfldjsaklfjdlksajfkdlsjaflkdjsaklfjdkslafjdlksajfkldas,&
                                           fjdklajfdklsajfkldsa,fjdkalsjfkldaf)
   call my_sub('fjkdajflkkfdajfkdlajfklajfkldjaskfldja,fjdlaj kldjaklfjd,      &
                                        fjdklasjfkdlsajfklajfkldjaklf,jsdjfkl')
!
   end subroutine
!-------------------------------------------------------------------------------
!
