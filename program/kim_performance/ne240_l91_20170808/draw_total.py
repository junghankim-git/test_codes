...
carts = ''
pltfig,axis = create_plot(ncols=1,nrows=1,title='KIM scalability',base=5.5)
...
print ' - plot 2'
title1 = 'wall-clock time (KIM v3.0.09)'
title2 = 'KIM v3.0.09 (NE240L91, w/ I/O decomposition)'
draw_plots(axis,title1,carts,comps_,nprocs_,walltime_,xlabel=xlabel,ylabel=ylabel1,xmin=0.0,xmax=xmax2,ymin=0.0,ymax=2300,base=5.0)
#draw_plots(axis,title1,carts,comps_,nprocs_,walltime_,xlabel=xlabel,ylabel=ylabel1,xmin=0.0,xmax=xmax2,ymin=0.0)
#add_plots(axis,'elapse time',nprocs_,walltime_s,['bo-'])
#for i in range(nps):
