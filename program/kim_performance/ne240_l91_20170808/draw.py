...
title1 = 'KIM v2.5 (NE240L100, 0.5d fcst)'
title2 = 'KIM v2.5 (NE240L100, 0.5d fcst)'
...
print ' - plot 2'
title1 = 'KIM v3.0.09 (NE240L91, 0.5d fcst)'
title2 = 'KIM v3.0.09 (NE240L91, 0.5d fcst)'
...
add_plots(axis[1][1],'Total (w/o set, ini)',nprocs_,speedup_s,['bo-'])
add_plots(axis[1][1],'Ideal',nprocs_id,nprocs_id,['r-'],leg_loc=2)

pltfig.savefig('fig.png')


pltfig,axis = create_plot(ncols=2,nrows=1,title='KIM scalability')
comps = ['Total','Total (w/o set, ini)']
title = 'Speed-up (fitting)'
fmts  = ['k-','b-']
draw_plots(axis[0][0],title,carts,comps,nprocs_f,[sps1_f,sps2_f],fmts=fmts,xlabel=xlabel,ylabel=ylabel1,xmin=0.0,xmax=720000,ymax=720000,leg_loc=2)
add_plots(axis[0][0],'Ideal',nprocs_f,nprocs_f,['r--'],leg_loc=2)
title = 'Efficiency'
ylabel2 = 'efficiency [%]'
draw_plots(axis[1][0],title,carts,comps,nprocs_f,[efs1_f,efs2_f],fmts=fmts,xlabel=xlabel,ylabel=ylabel2,xmin=0.0,xmax=720000,ymin=0.0,ymax=105,leg_loc=1)

pltfig.savefig('fig2.png')
